 ...
 */
const CellMixin = superclass => class extends superclass {
  constructor(config) {
    super(config);
  ...
  getCellViewParams(cell = this.cell) {
    ...
    const center = [(diagonal[0][0] + diagonal[1][0]) / 2, (diagonal[0][1] + diagonal[1][1]) / 2, (diagonal[0][2] + diagonal[1][2]) / 2];
