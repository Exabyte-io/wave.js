...
export const ImageMixin = (superclass) => class extends superclass {
    ...
    getWorldUnitsPerPixel(pixelHeight) {
        ...
        const target = ((_a = this.orbitControls) === null || _a === void 0 ? void 0 : _a.target) || new THREE.Vector3();
    ...
    composeFigureWithScaleBar({ width, height, backgroundOption }) {
        ...
        if (!plan)
            return this.getScreenshotImage();
    ...
    exportFigure(options = {}) {
        ...
        const fileName = getFigureFileName({
            name: (_a = this._structure) === null || _a === void 0 ? void 0 : _a.name,
            formula: (_b = this._structure) === null || _b === void 0 ? void 0 : _b.formula,
            width: options.width,
