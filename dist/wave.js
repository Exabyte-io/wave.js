...
var _atoms = require("./mixins/atoms");
var _bonds = require("./mixins/bonds");
var _boundary = require("./mixins/boundary");
var _cell = require("./mixins/cell");
var _controls = require("./mixins/controls");
 ...
 */
class Wave extends (0, _mixwith.mix)(WaveBase).with(_atoms.AtomsMixin, _bonds.BondsMixin, _cell.CellMixin, _repetition.RepetitionMixin, _controls.ControlsMixin, _boundary.BoundaryMixin, _labels.LabelsMixin, _measurement.MeasurementMixin) {
  /**
   *
   * @param {Object} config
   */
