...
import { formatEditorKey } from "./keyBindings";
/**
 ...
 */
export function describeEditCommit(source) {
    var _a;
    if (!source)
        return null;
    ...
    if (source === "undo" || source === "redo")
        return phrase;
    const undoBinding = (_a = settings.editorKeysConfig) === null || _a === void 0 ? void 0 : _a.undo;
