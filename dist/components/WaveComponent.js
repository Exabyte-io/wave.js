 ...
 */
class WaveComponent extends _react.default.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    if (this.wave) {
      ...
      this.reloadViewer(prevStructure.hash !== structure.hash || prevSettings.chemicalConnectivityFactor !== settings.chemicalConnectivityFactor || prevIsConventionalCellShown !== isConventionalCellShown || prevIsDrawBondsEnabled !== isDrawBondsEnabled);
    }
...
WaveComponent.propTypes = {
  ...
  triggerHandleResize: _propTypes.default.bool.isRequired,
  // Wave settings
  // eslint-disable-next-line react/forbid-prop-types
  settings: _propTypes.default.object.isRequired,
  // Material structure to be visualized
  // eslint-disable-next-line react/forbid-prop-types
  structure: _propTypes.default.object.isRequired,
  // Expects "cell" property to represent the crystal unit cell for the atomic arrangement. Made.js UnitCell object.
  // eslint-disable-next-line react/forbid-prop-types
  cell: _propTypes.default.object.isRequired,
  // eslint-disable-next-line react/forbid-prop-types
  boundaryConditions: _propTypes.default.object.isRequired,
  isConventionalCellShown: _propTypes.default.bool.isRequired,
  isDrawBondsEnabled: _propTypes.default.bool.isRequired,
  isViewAdjustable: _propTypes.default.bool.isRequired
};