...
export class WaveComponent extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        const { structure: prevStructure, settings: prevSettings, isConventionalCellShown: prevIsConventionalCellShown, isDrawBondsEnabled: prevIsDrawBondsEnabled, } = prevProps;
