...
export class ThreeDEditor extends React.Component {
    ...
    constructor(props) {
            ...
            return [
                {
                    ...
                    rightIcon: this.getToggleIndicator(this._getWaveProperty("areOrbitControlsEnabled"), settings.hotKeysConfig.toggleOrbitControls),
                ...
                },
                {
                    ...
                    rightIcon: this.getToggleIndicator(this._getWaveProperty("isOrbitControlsAnimationEnabled")),
                ...
                },
                {
                    ...
                    rightIcon: this.getToggleIndicator(this._getWaveProperty("isDrawBondsEnabled"), settings.hotKeysConfig.toggleBonds),
                ...
                },
                {
                    ...
                    rightIcon: this.getToggleIndicator(areLabelsVisibleByType && areLabelsVisibleByType("element"), settings.hotKeysConfig.toggleElementLabels),
                ...
                },
                {
                    ...
                    content: "Coordinates",
                    leftIcon: _jsx(Spellcheck, {}),
                    rightIcon: this.getToggleIndicator(areLabelsVisibleByType && areLabelsVisibleByType("coordinate"), settings.hotKeysConfig.toggleCoordinateLabels),
            ...
            return [
                {
                    id: "Distances",
                    content: "Distances",
                    rightIcon: this.getToggleIndicator(measurementsSettingsHandler.isMeasurementActiveByType(MEASUREMENT_MODES.DISTANCE), settings.hotKeysConfig.toggleDistanceShown),
                ...
                },
                {
                    id: "Angles",
                    content: "Angles",
                    rightIcon: this.getToggleIndicator(measurementsSettingsHandler.isMeasurementActiveByType(MEASUREMENT_MODES.ANGLE), settings.hotKeysConfig.toggleAnglesShown),
                ...
                },
                {
                    ...
                    rightIcon: this.getToggleIndicator(measurementsSettingsHandler.isMeasurementActiveByType(MEASUREMENT_MODES.COORDINATE), settings.hotKeysConfig.toggleCopyCoordinatesShown),
                    leftIcon: _jsx(GpsFixed, {}),
        ...
        this.getParametersActions = () => {
            ...
            return (_jsx(ParametersMenu, { viewerSettings: viewerSettings, 
                // Lets the menu state what a repetition will cost instead of leaving the user to
                // discover it by waiting (F7).
                atomCountInCell: ((_b = (_a = material === null || material === void 0 ? void 0 : material.basis) === null || _a === void 0 ? void 0 : _a.elements) === null || _b === void 0 ? void 0 : _b.length) || 0, 
    ...
    _applyInitialToggleSettings() {
        ...
        if (!((_a = this.WaveComponent) === null || _a === void 0 ? void 0 : _a.wave)) {
            if (this._initialToggleSettingsRetried)
                return;
            this._initialToggleSettingsRetried = true;
            this._initialToggleSettingsTimeout = setTimeout(() => this._applyInitialToggleSettings(), 0);
            return;
        }
    ...
    handleViewerError(error) {
        ...
        this.setState({ viewerError: (error === null || error === void 0 ? void 0 : error.message) || String(error) });
    }
    handleRetryViewer() {
    ...
    getViewerStatusKind() {
        ...
        if (!material)
            return "empty";
        const atomCount = (_b = (_a = material.basis) === null || _a === void 0 ? void 0 : _a.elements) === null || _b === void 0 ? void 0 : _b.length;
        if (!atomCount)
            return "empty";
        return null;
    }
    ...
    handleViewAlongAxis(axis) {
        var _a, _b, _c;
        (_c = (_b = (_a = this.WaveComponent) === null || _a === void 0 ? void 0 : _a.wave) === null || _b === void 0 ? void 0 : _b.setCameraAlongCellVector) === null || _c === void 0 ? void 0 : _c.call(_b, axis);
    }
    ...
    getDisplayCoordinates() {
        ...
        if (selectedAtomIndices.length !== 1 || !displayUnits)
            return null;
        const nativeUnits = ((_a = material === null || material === void 0 ? void 0 : material.basis) === null || _a === void 0 ? void 0 : _a.units) === "cartesian" ? "cartesian" : "crystal";
        if (displayUnits === nativeUnits)
            return null;
        const point = (_d = (_c = (_b = material === null || material === void 0 ? void 0 : material.basis) === null || _b === void 0 ? void 0 : _b.coordinates) === null || _c === void 0 ? void 0 : _c[selectedAtomIndices[0]]) === null || _d === void 0 ? void 0 : _d.value;
    ...
    getSelectedElementSymbol() {
        ...
        return normalizeElement((_b = (_a = material === null || material === void 0 ? void 0 : material.basis) === null || _a === void 0 ? void 0 : _a.elements) === null || _b === void 0 ? void 0 : _b[index]);
    }
    /**
    ...
    handleSelectElement(elementSymbol) {
        ...
        const wave = (_a = this.WaveComponent) === null || _a === void 0 ? void 0 : _a.wave;
        const { material } = this.state;
        if (!(wave === null || wave === void 0 ? void 0 : wave.reselectAtomsByIndices))
            return;
        const elements = (_b = material === null || material === void 0 ? void 0 : material.basis) === null || _b === void 0 ? void 0 : _b.elements;
        if (!Array.isArray(elements))
            return;
        const indices = elements.reduce((accumulated, entry, index) => {
            if (normalizeElement(entry) === elementSymbol)
    ...
    getToggleIndicator(isActive, hotKey) {
        return _jsx(ToggleIndicator, { isActive: Boolean(isActive), hotKey: hotKey });
    }
    /**
     ...
     */
    getQuickToggleItems() {
        const areLabelsVisibleByType = (type) => { var _a, _b, _c; return (_c = (_b = (_a = this.WaveComponent) === null || _a === void 0 ? void 0 : _a.wave) === null || _b === void 0 ? void 0 : _b.areLabelsVisibleByType) === null || _c === void 0 ? void 0 : _c.call(_b, type); };
    ...
    renderEditSurface() {
        var _a, _b, _c, _d;
        const { activeTransformMode, selectedAtomIndices, material, coordinateDrafts, elementDraft, displayUnits, } = this.state;
        const { editSessionOptions } = this.props;
        const [selectedAtomIndex] = selectedAtomIndices;
        let selectedCoordinates = [0, 0, 0];
        if (selectedAtomIndices.length === 1) {
            const selectedAtom = (_b = (_a = material === null || material === void 0 ? void 0 : material.basis) === null || _a === void 0 ? void 0 : _a.coordinates) === null || _b === void 0 ? void 0 : _b[selectedAtomIndex];
            if (selectedAtom) {
        ...
        const elementColor = selectedElement
            ? ((_c = settings.elementColors) === null || _c === void 0 ? void 0 : _c[selectedElement]) || settings.defaultColor
            : settings.defaultColor;
        return (_jsxs(Stack, { direction: "row", spacing: 1, alignItems: "flex-start", justifyContent: "flex-end", sx: {
                position: "absolute",
                top: "1em",
                right: "1em",
                left: "1em",
    ...
    renderViewerWithToolbars() {
        ...
        return (_jsxs("div", { className: "wave-component-holder", style: { position: "relative", height: "100%" }, children: [this.renderCoverDiv(), _jsx(IconsToolbar, { toolbarConfig: this.getToolbarConfig(), 
    ...
    render() {
        ...
        return (_jsx(ThemeProvider, { theme: DarkMaterialUITheme, children: _jsx(ScopedCssBaseline, { enableColorScheme: true, style: { height: "100%" }, children: isStandalone ? (_jsx(AlertProvider, { children: this.renderViewerWithToolbars() })) : (this.renderViewerWithToolbars()) }) }));
    }
}
