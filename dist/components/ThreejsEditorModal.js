...
import { Editor, Menubar, Player, RemoveMultipleSelectionGroupCommand, Script, SetSceneCommand, Sidebar, SubmitMultipleSelectionCommand, Toolbar, Viewport, } from "@mat3ra/threejs-editor";
...
export class ThreejsEditorModal extends ModalDialog {
    ...
    submitMultipleSelectionGroup() {
        this.editor.execute(new SubmitMultipleSelectionCommand(this.editor, this.editor.multipleSelection));
    }
    /**
    ...
    renderBody() {
        return (_jsxs(_Fragment, { children: [_jsx(AlertDialog, { ref: (ref) => (this.alertRef = ref) }), _jsx("div", { ref: (el) => this.initialize(el) })] }));
    }
}
